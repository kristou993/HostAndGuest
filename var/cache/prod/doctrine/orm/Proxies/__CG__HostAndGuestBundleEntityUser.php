...
namespace Proxies\__CG__\HostAndGuestBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \HostAndGuestBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'HostAndGuestBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'HostAndGuestBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'HostAndGuestBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'HostAndGuestBundle\\Entity\\User' . "\0" . 'photo', '' . "\0" . 'HostAndGuestBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'HostAndGuestBundle\\Entity\\User' . "\0" . 'image', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
